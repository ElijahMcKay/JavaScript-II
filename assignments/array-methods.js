...
let ticketPriceTotal = runners.reduce(function(counter, runner) {
...
// Problem 1
// Take all of the people's names you turned upper case to all lower case, because the director realized that he wasn't making any sense. 
let allLower = runners.map(element => element.first_name.toLowerCase()); 
